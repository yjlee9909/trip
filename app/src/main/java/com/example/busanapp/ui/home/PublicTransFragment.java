...
public class PublicTransFragment extends Fragment implements OnMapReadyCallback {
    ...
    String[] category_value_array={
            "all","bus_station","subway_station"
    };
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstance){
        View view = inflater.inflate(R.layout.fragment_publictrans, container, false);
