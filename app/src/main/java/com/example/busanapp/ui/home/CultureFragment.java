...
public class CultureFragment extends Fragment implements OnMapReadyCallback {
    ...
    String[] category_name_array={
            "모두","놀이동산","박물관","백화점","공원","관광명소","영화관","나이트 클럽"
    };

    // types 값 배열
    String[] category_value_array={
            "all","amusement_park","museum","department_store","park","tourist_attraction","movie_theater", "night_club"
    };
